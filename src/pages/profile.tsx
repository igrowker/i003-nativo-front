    ...
    <div className="mx-auto mt-0 max-w-md overflow-hidden rounded-lg bg-white shadow-md md:max-w-2xl">
      ...
      <div className="p-6">
        ...
        <input
          ...
          className="mb-4 w-full appearance-none rounded border px-3 py-2 text-gray-700 shadow"
          placeholder="CVU"
        />

        <h3 className="mb-2 text-lg">Editar datos personales</h3>
        ...
        <div className="relative mb-4">
          ...
          <span className="absolute inset-y-0 right-3 flex items-center">
            ...
            >
              <path
                d="M16.4352 2.72876C16.0634 2.72977 15.6954 2.80434 15.3525 2.94818C15.0096 3.09201 14.6986 3.30226 14.4373 3.56682L3.56589 14.4376L3.52327 14.6528L2.77114 18.434L2.55664 19.4433L3.56658 19.2288L7.34783 18.4766L7.56233 18.4333L18.4338 7.56257C18.6991 7.30182 18.9099 6.99083 19.0537 6.64775C19.1976 6.30467 19.2717 5.93638 19.2717 5.56435C19.2717 5.19233 19.1976 4.82404 19.0537 4.48096C18.9099 4.13788 18.6991 3.82689 18.4338 3.56613C18.1723 3.30162 17.8612 3.09144 17.5182 2.94773C17.1752 2.80401 16.8071 2.72959 16.4352 2.72876ZM16.4352 4.03913C16.7817 4.03913 17.131 4.19726 17.4665 4.53345C18.1354 5.2017 18.1354 5.92701 17.4665 6.59595L16.9728 7.06826L14.931 5.02707L15.404 4.53345C15.7401 4.19726 16.0887 4.03913 16.4352 4.03913ZM13.965 5.99438L16.0055 8.03557L7.69158 16.3488C7.24324 15.4703 6.52854 14.7561 5.6497 14.3083L13.965 5.99438ZM4.7697 15.4262C5.17667 15.5898 5.54635 15.834 5.85649 16.1441C6.16664 16.4542 6.41083 16.8239 6.57439 17.2309L4.31802 17.6819L4.7697 15.4262Z"
                fill="#D3D2D2"
              />
            </svg>
          </span>
        ...
        <label className="mb-2 block text-sm text-gray-700" htmlFor="phone">
        ...
        <button
          className="w-full rounded-full bg-[#FFC905] px-5 py-2 text-black shadow-md"
          onClick={handleSubmit}
        >
          Guardar cambios
        </button>

        <button className="text-black-500 mt-4 w-full">Cerrar sesión</button>
      </div>
    </div>
  );
};
